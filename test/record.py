...
class Record(object):
    ...
    def __init__(self, filename, recording_path, mismatch_path):
        ...
        if not extension in extension_map:
            raise NotImplementedError("We have no mapping for {}".format(extension))
...
class RecordError(Exception):
    ...
    def __init__(
        self, filename, recording_path, recording_data, mismatch_path, mismatch_data
    ):
...
class JsonRecord(TextRecord):
    def __init__(self, filename, recording_path, mismatch_path):
        super(JsonRecord, self).__init__(filename, recording_path, mismatch_path)
...
extension_map = {".json": JsonRecord, ".rst": TextRecord, ".txt": TextRecord}
