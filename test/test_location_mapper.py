...
def test_location_mapper_to_include(testdirectory, caplog):
    ...
    project_dir = pathlib.Path(
        testdirectory.copy_dir(directory="test/data/location_mapper").path()
    )
    ...
    assert (
        mapper.to_include(path=project_dir / "tmp/project_a/src/include/header.h")
        == None
    )
...
def test_location_mapper_to_path(testdirectory):
    ...
    assert (
        mapper.to_path(path=project_dir / "tmp/../tmp/project_a/./src/include/header.h")
